...
process.output = cms.OutputModule(
    "PoolOutputModule",
    fileName = cms.untracked.string('skimmed.root'),  # output file name
    SelectEvents = cms.untracked.PSet(SelectEvents = cms.vstring('forest')), # save only events passing the "skimPath"
